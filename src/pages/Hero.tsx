...
function Hero() {
  return (
    <>
      <div className="lg:dark:bg-[url('/hero_dark.webp')] lg:bg-[url('/hero_light.webp')] bg-cover">
        <Navbar />
        <div className='pt-16 pr-0 pl-0 pb-8 z-50'>
          <div className='max-w-7xl my-[3rem] mx-auto  py-0 text-center px-3.5 items-center gap-24'>
            <div className='px-4 w-[60%] mx-auto'>
              ...
              <div className='text-center mx-auto px-4'>
                <p className='text-amber-800 font-semibold px-8 dark:text-gray-100 dark:hover:text-pink-500 hover:text-amber-900 transition-all duration-300 font-poppins text-xl opacity-70 leading-10'>
                  Are you lagging to find the best exercises for your muscles ?
                </p>
                <p className='text-amber-800 font-semibold px-8 dark:text-gray-100 dark:hover:text-pink-500 hover:text-amber-900 transition-all font-poppins text-xl opacity-70 leading-10 decoration-inherit'>
                  Now your wait is over with BodyWorks!{' '}
                </p>
                <p className='text-amber-800 font-semibold dark:text-gray-100 dark:hover:text-pink-500 hover:text-amber-900 transition-all font-poppins text-xl opacity-70 leading-10 mb-16'>
