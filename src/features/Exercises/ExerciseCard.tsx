...
const ExerciseCard = (props: IProps) => {
  ...
  return (
    <>
      <div className="bg-[#F9B572] max-w-sm mx-12 overflow-y-scroll scrollbar-hide h-80 dark:bg-gray-900 mt-10 border dark:border-gray-800 border-amber-700 rounded-xl overflow-hidden">
